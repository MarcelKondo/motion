        ...
        if results.multi_hand_landmarks is not None:
            for hand_landmarks, handedness in zip(
                ...
                if results_pose.pose_landmarks is not None:
                    ...
                    motion_gesture = identify_motion_gesture(
                        hand_sign_id, handedness, results_pose
                    )
                    last_command_time = cooldown_send_command(
                        motion_gesture, last_command_time
                    )
                    ##########################################################
...
def cooldown_send_command(motion_gesture, last_command_time):
    ...
    url = "http://192.168.68.120:8123/api/events/rhasspy_ChangeLightState"
    headers = {
        "Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiIxYzE1NzcwNjFkY2Q0NjhlYTU1OGI0ODAyMDY2ZGMzZSIsImlhdCI6MTcwMzQyOTQ2MSwiZXhwIjoyMDE4Nzg5NDYxfQ.ytsNshDFpn4OhEw3-A5aCA5cV_838uaYxiEgi4gzKCA",
...
def draw_info_text(
    image, brect, handedness, hand_sign_text, finger_gesture_text, motion_gesture
):
